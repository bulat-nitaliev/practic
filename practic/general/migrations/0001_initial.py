    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('islam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='general.islam')),
                ('vred_privichki', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='general.vredprivichki')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='general.cel')),
            ],
        ),
    ]
