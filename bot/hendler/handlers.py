...
async def start(message:types.Message, state:FSMContext):
    ...
    await message.answer('Сколько сегодня страниц Корана 📖 прочитали? Ответь цифрами 🔢', reply_markup=types.ReplyKeyboardRemove())
...
async def start(message:types.Message):
    ...
    await message.answer('''
        ...
        Необходимо по очереди прожать кнопки "Ислам" 🕌 и "Вредные привычки" 🚫,\n
        ответив на вопросы в каждой.\n\n
